...
export function IntroCard({ content }: IntroCardProps) {
  ...
  return (
    <div className="flexflex-col items-center rounded-2xl bg-white border-2 border-[#f8a3c9] p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-2xl w-full h-[65dvh]">
      ...
      <div className="space-y-4">
        {paragraphs.map((paragraph, index) => (
          <p key={index} className=" leading-relaxed text-sm sm:text-sm whitespace-pre-line font-[Montserrat-Light]">
            {paragraph}
          </p>
        ))}
