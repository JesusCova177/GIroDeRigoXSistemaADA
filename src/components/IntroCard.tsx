...
export function IntroCard({ content }: IntroCardProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl bg-white border-l-4 border-blue-500 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 overflow-y-auto  shadow-xl">
