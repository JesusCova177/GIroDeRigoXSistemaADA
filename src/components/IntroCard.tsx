...
export function IntroCard({ content }: IntroCardProps) {
  ...
  return (
    <div className="flexflex-col items-center rounded-2xl bg-white border-t-2 border-r-2  border-b-2 border-[#f8a3c9] p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-xl w-full">
