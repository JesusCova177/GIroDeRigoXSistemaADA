...
export function IntroCard({ content }: IntroCardProps) {
  ...
  return (
    <div className="flex items-center rounded-2xl bg-white border-l-4 border-blue-500 p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 flex-col overflow-y-auto h-[60vh] shadow-xl">
