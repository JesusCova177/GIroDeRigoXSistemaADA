...
export function NutritionGuideCard({
  ...
  return (
    <div className="flex-shrink-0 w-full bg-white rounded-2xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500 hover:shadow-xl transition-all duration-300 h-[55vh]">
