      ...
      <div className="relative">
        {totalCards > 1 && currentIndex > 0 && (
          <button
            ...
            className="flex absolute left-2 sm:left-0 top-[33%] -translate-y-1/2 sm:-translate-x-4 z-10 bg-white hover:bg-gray-50 text-gray-700 p-3 rounded-full shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-110 items-center justify-center"
            aria-label="Anterior"
          >
