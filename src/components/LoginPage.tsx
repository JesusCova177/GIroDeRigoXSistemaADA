...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="h-dvh bg-white from-blue-600 via-blue-700 to-blue-800 flex items-center justify-center p-4 overflow-hidden">
 ...
 <h1 className="text-2xl text-[#F8A3C9] block self-center justify-self-center text-center">
            Roadmap de Alimentación Giro de Rigo 2026 by <span className="text-ehite">SISTEMA</span><span className="text-[#ffcc00]">ADA</span>
            </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#E39EC5] hover:from-[#2a4833] hover:to-[#1f3626] text-white font-titling font-black py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 italic uppercase tracking-wide"
          >
            {loading ? (
              <>
