...
export function TestimonialCard({ content }: TestimonialCardProps) {
  ...
  return (
    <div className="flex-shrink-0 w-full bg-gradient-to-br from-yellow-50 via-white to-blue-50 rounded-2xl sm:rounded-3xl shadow-xl p-3 sm:p-5 border-2 border-yellow-200 hover:shadow-2xl transition-all duration-300 relative h-auto flex flex-col">
      ...
      <div className="relative z-10">
        <div className="flex items-start gap-2 mb-1 sm:mb-2">
          ...
          <div className="flex-1">
            <h3 className="text-lg sm:text-xl md:text-2xl font-titling font-black text-[#31563C] tracking-tight italic mb-0">
              {title}
            </h3>
        ...
        <div className="bg-white/80 rounded-xl p-3 sm:p-4 border-2 border-yellow-100 shadow-inner mb-3 sm:mb-4">
          ...
          <div className="mb-2 sm:mb-4">
            ...
            {videoEmbed ? (
              ...
              <div className="mb-2">
                <div className="relative w-full max-w-[260px] mx-auto rounded-2xl overflow-hidden shadow-2xl border-4 border-white ring-2 ring-yellow-100" style={{ aspectRatio: '9/16' }}>
                  <div 
