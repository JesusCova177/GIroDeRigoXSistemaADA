...
export function TestimonialCard({ content }: TestimonialCardProps) {
  ...
  return (
    <div className="flex-shrink-0 w-full  rounded-2xl sm:rounded-3xl shadow-xl p-3 sm:p-5 border-2 border-black-400 hover:shadow-2xl transition-all duration-300 relative h-auto flex flex-col">
